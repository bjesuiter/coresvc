    ...
    describe("Tampered Data Detection", () => {
      it("should detect tampered ciphertext", () => {
        ...
        if (encryptedResult.isOk()) {
          ...
          const tamperedCiphertext = encryptedResult.value.ciphertext.slice(0, -2) + "XX";
          const tamperedData = {
    ...
    describe("Invalid Base64 Handling", () => {
      ...
      it("should reject invalid IV length", () => {
        ...
        if (encryptedResult.isOk()) {
          ...
          if (decryptedResult.isErr()) {
            expect(decryptedResult.error.message).toContain("Invalid IV length");
          }
        }
      });
      ...
      it("should reject invalid authentication tag length", () => {
        ...
        if (encryptedResult.isOk()) {
          ...
          if (decryptedResult.isErr()) {
            expect(decryptedResult.error.message).toContain("Invalid authentication tag length");
          }
        }
      });
    });
